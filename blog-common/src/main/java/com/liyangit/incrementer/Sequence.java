...
/**
 * <h2> 分布式高效有序 ID 生产黑科技(sequence)</h2>
 * <p>
 * 优化开源项目：<a href="https://gitee.com/yu120/sequence">https://gitee.com/yu120/sequence</a>
 * </p>
 *
 * @author LiYang
 */
public class Sequence {
	...
	public Sequence(InetAddress inetAddress) {
		...
		if (end - start > Sequence.MAX_START_INTERVAL_TIME) {
			...
			logger.warn("Initialization Sequence Very Slow! Get datacenterId:{} workerId:{}", this.datacenterId, this.workerId);
		} else {
			initLog();
		}
	}
	...
	public Sequence(long workerId, long datacenterId) {
		if (workerId > maxWorkerId || workerId < 0) {
			throw new IllegalArgumentException(String.format("worker Id不能大于 %s，也不能小于0", maxWorkerId));
		}
		if (datacenterId > maxDatacenterId || datacenterId < 0) {
			throw new IllegalArgumentException(String.format("datacenter Id不能大于 %s  或小于0", maxDatacenterId));
		}
